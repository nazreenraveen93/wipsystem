...
namespace WIPSystem.Web.Models
{
    public class Insp5
    {
        ...
        public string ProcessCurrentStatus { get; set; } = "Insp.5"; // Default status
        public string CheckedBy { get; set; }
        public Insp5ProcessStatus Status { get; set; }
    ...
    public enum Insp5ProcessStatus
    {
