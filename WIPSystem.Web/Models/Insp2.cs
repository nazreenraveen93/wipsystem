...
namespace WIPSystem.Web.Models
{
    public class Insp2
    {
        ...
        public string ProcessCurrentStatus { get; set; } = "Insp2"; // Default status
        public string CheckedBy { get; set; }
        public Insp2ProcessStatus Status { get; set; }
    ...
    public enum Insp2ProcessStatus
    {
