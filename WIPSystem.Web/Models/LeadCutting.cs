...
{
    public class LeadCutting
    {
        // Assuming SinterId is an auto-incrementing primary key
        public int LeadCuttingId { get; set; }
        ...
        public string ProcessCurrentStatus { get; set; } = "Lead Cutting"; // Default status
        public string CheckedBy { get; set; }
        public LeadCuttingProcessStatus Status { get; set; }
    ...
    public enum LeadCuttingProcessStatus
    {
