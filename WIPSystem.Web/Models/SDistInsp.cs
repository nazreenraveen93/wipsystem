...
namespace WIPSystem.Web.Models
{
    public class SDistInsp
    {
        ...
        public string ProcessCurrentStatus { get; set; } = "S Dist Insp"; // Default status
        public string CheckedBy { get; set; }
        public SDistInspProcessStatus Status { get; set; }
    ...
    public enum SDistInspProcessStatus
    {
