...
namespace WIPSystem.Web.Models
{
    public class ReScr5
    {
        ...
        public int ReScr5Id { get; set; }
        // String properties for the varchar fields
        public string PartNo { get; set; }
        public string LotNo { get; set; }
        // DateTime properties for date and datetime fields
        public DateTime Date { get; set; }
        public string ProcessCurrentStatus { get; set; } = "Re-Scr.5"; // Default status
        public string CheckedBy { get; set; }
        public ReScr5ProcessStatus Status { get; set; }
    ...
    public enum ReScr5ProcessStatus
    {
