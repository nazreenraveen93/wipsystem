...
namespace WIPSystem.Web.Models
{
    public class Short3
    {
        ...
        public string ProcessCurrentStatus { get; set; } = "Short3"; // Default status
        public string CheckedBy { get; set; }
        public Short3ProcessStatus Status { get; set; }
    ...
    public enum Short3ProcessStatus
    {
