...
{
    public class CamberInspAll
    {
        // Assuming SinterId is an auto-incrementing primary key
        public int CamberInspAllId { get; set; }
        ...
        public string ProcessCurrentStatus { get; set; } = "Camber Insp.All"; // Default status
        public string CheckedBy { get; set; }
        public CamberInspAllProcessStatus Status { get; set; }
    ...
    public enum CamberInspAllProcessStatus
    {
