...
{
    public class TiNiAuPlating
    {
        // Assuming SinterId is an auto-incrementing primary key
        public int TiNiAuPlatingId { get; set; }
        ...
        public string ProcessCurrentStatus { get; set; } = "Ti Ni Au Plating"; // Default status
        public string CheckedBy { get; set; }
        public TiNiAuPlatingProcessStatus Status { get; set; }
    ...
    public enum TiNiAuPlatingProcessStatus
    {
