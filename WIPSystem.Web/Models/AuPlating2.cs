...
{
    public class AuPlating2
    {
        // Assuming SinterId is an auto-incrementing primary key
        public int AuPlating2Id { get; set; }
        ...
        public string ProcessCurrentStatus { get; set; } = "Au Plating2"; // Default status
        public string CheckedBy { get; set; }
        public AuPlating2ProcessStatus Status { get; set; }
    ...
    public enum AuPlating2ProcessStatus
    {
