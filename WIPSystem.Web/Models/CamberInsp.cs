...
{
    public class CamberInsp
    {
        // Assuming SinterId is an auto-incrementing primary key
        public int CamberInspId { get; set; }
        ...
        public string ProcessCurrentStatus { get; set; } = "Camber Insp."; // Default status
        public string CheckedBy { get; set; }
        public CamberInspProcessStatus Status { get; set; }
    ...
    public enum CamberInspProcessStatus
    {
