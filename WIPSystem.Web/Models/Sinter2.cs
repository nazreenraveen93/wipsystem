...
namespace WIPSystem.Web.Models
{
    public class Sinter2
    {
        ...
        public string ProcessCurrentStatus { get; set; } = "750Sinter2"; // Default status
        public string CheckedBy { get; set; }
        public Sinter2ProcessStatus Status { get; set; }
    ...
    public enum Sinter2ProcessStatus
    {
