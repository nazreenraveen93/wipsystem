...
namespace WIPSystem.Web.Models
{
    public class SAirblow
    {
        ...
        public string ProcessCurrentStatus { get; set; } = "S.Airblow"; // Default status
        public string CheckedBy { get; set; }
        public SAirblowProcessStatus Status { get; set; }
    ...
    public enum SAirblowProcessStatus
    {
